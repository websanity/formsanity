...
export function checkRule(rule, field, ctx, trigger) {
	...
	switch (rule.kind) {
		...
		case 'constraint': {
			...
			// A constraint judges answers, not absence: while any referenced field is unanswered there is nothing to judge yet, and the grammar's empty-is-false polarity must not flag this field for a question nobody has answered.
