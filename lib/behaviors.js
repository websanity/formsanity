...
function wireCaps(form) {
	for (const control of form.querySelectorAll('[data-fs-prefix], [data-fs-suffix], input[data-fs-reveal], input[type="file"], input[type="date"], input[type="time"]')) {
		...
		} else if (control.matches('input[type="date"], input[type="time"]')) {
