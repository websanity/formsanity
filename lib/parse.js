...
export function parseForm(form) {
	...
	// Relevance regions: data-fs-relevant on anything that is not a control. One expression governs every field inside the element; an element with no fields in it is pure conditional content.
