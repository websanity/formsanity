...
function rulesFor(controls) {
	...
	// Conditional requiredness sits on any member of a set, like the selection counts. Native required wins: a field whose first control carries it is always required, so the expression would be dead, and the author is told once.
