# The FormSanity Guide (Simple English)

This guide teaches you to write FormSanity forms. It is the Simple English version of [the guide](guide.md). The [vocabulary spec](../specs/vocabulary.md) is the full definition. Where this guide and a spec disagree, the spec is correct.
