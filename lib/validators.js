...
function duration(value) {
	...
	// A zero duration is no duration. With both minute digits typed it is a dead end — no appended character can make it non-zero — but a bare "0" or "0:0" can still grow into "0:30".
